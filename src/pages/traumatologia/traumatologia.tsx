    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 bg-blue-600 text-white text-center">
          <h1 className="text-4xl font-bold mb-4">Traumatología</h1>
          <p className="max-w-3xl mx-auto text-lg text-blue-100">
            Diagnóstico, tratamiento y rehabilitación de lesiones óseas, articulares y musculares con atención integral.
          </p>
        </section>

        {/* Contenido principal */}
        <section className="max-w-5xl mx-auto px-6 py-16 bg-white rounded-xl shadow-md mt-10 mb-20">
          <h2 className="text-2xl font-semibold text-slate-900 mb-4">Atención traumatológica especializada</h2>
          <p className="text-gray-700 leading-relaxed mb-6">
            El servicio de <strong>Traumatología</strong> brinda atención médica completa en lesiones del sistema
            musculoesquelético, tanto agudas como crónicas, con un enfoque multidisciplinario que prioriza la recuperación funcional del paciente.
          </p>

          <h3 className="text-xl font-semibold text-blue-700 mb-3">Servicios incluidos</h3>
          <ul className="list-disc list-inside text-gray-700 mb-6">
            <li>Tratamiento de fracturas y lesiones óseas</li>
            <li>Cirugía ortopédica y artroscópica</li>
            <li>Atención de lesiones deportivas</li>
            <li>Rehabilitación postoperatoria</li>
            <li>Evaluación del dolor articular y muscular</li>
          </ul>

          <h3 className="text-xl font-semibold text-blue-700 mb-3">Beneficios del servicio</h3>
          <p className="text-gray-700 leading-relaxed mb-6">
            Contamos con tecnología avanzada y un equipo de profesionales especializados que garantizan un diagnóstico preciso,
            tratamientos efectivos y una recuperación rápida y segura.
          </p>
          ...
          <div className="text-center mt-10">
            <a
              href="https://wa.me/5493535106738?text=Hola!%20Quiero%20más%20información%20sobre%20el%20servicio%20de%20Traumatología."
              target="_blank"
